...
public class UserListHolder extends ArrayAdapter<String> {
	private final Activity context;
	private final ArrayList<String> web;
	private final ArrayList<Bitmap> imageId;

	public UserListHolder(Activity context, ArrayList<String> web,
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		Bitmap resized = Bitmap.createScaledBitmap(imageId.get(position), 60,
				60, true);
